...
"""
This code has been taken from https://github.com/markvdw/RobustGP
"""
...
def ConditionalVariance(training_inputs: np.ndarray, M, kernel, sample = False, threshold = 0.):
        """
        ...
        for m in range(M - 1):
            ...
            if np.sum(np.clip(di, 0, None)) < threshold:
                indices = indices[:m]
